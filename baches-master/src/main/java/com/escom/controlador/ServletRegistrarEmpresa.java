...
public class ServletRegistrarEmpresa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String e = conexion.registrarEmpresa(request.getParameter("rfc"), request.getParameter("nombre"), request.getParameter("email"), request.getParameter("tel"));
            ...
            out.println("<title>Registrar Empresa</title>");            
            out.println("</head>");
            out.println("<body>");
...
"                    </li>\n" + 
"                    <li class=\"nav-item\">\n" +
"                        <a class=\"nav-link\" href=\"RegistrarEmpresa.html\">RegistrarEmpresa</a>\n" +
"                    </li>\n" + 
"                </ul>\n" +
"            </div>\n" +
"        </nav>");
            if(e!=null){
                ...
                out.println("<h1>Empresa registrada con exito</h1>");
            }
